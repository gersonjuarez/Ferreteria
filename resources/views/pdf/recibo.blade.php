    ...
    <div class="zona_impresion">
        ...
        <table border="0" align="center" width="300px">
            <tr>
                ...
                .::<strong> Empresa X </strong>::.<br>
                DPI 10477157772<br>
                Nombre Apellido 1368,  Quetzaltenango, Guatemala - 931742904<br>
                </td>
            </tr>
            <tr>
        ...
        <table border="0" align="center" width="300px">
            ...
            <tr>
                <td>{{$det->cantidad}}</td>
                <td>{{$det->producto}}</td>
                <td align="right">Q {{$det->cantidad*$det->precio}}</td>
            </tr>
            @endforeach
          ...
          <!--   <tr>
           ...
           <!--  <tr>
            ...
            <td align="right"><b>Q {{$v->total}}</b></td>
            </tr>
            @endforeach
            <tr>
            <td colspan="3">&nbsp;</td>
            ...
            <tr>
            <td colspan="3" align="center">Empresa X</td>
            </tr>
            <tr>
            <td colspan="3" align="center">Quetzaltenanago - Guatemala</td>
            </tr>            
        </table>
        <br>
        </div>
