   ...
   <div
      ...
      ></v-progress-linear>
        ...
        <v-dialog v-model="dialogDesactivar" max-width="500px">
          <v-card>
            <v-card-title class="text-h5">¿Quieres habilitar este proveedor?</v-card-title>
            <v-card-actions>
              <v-spacer></v-spacer>
 ...
 v => !!v || 'El campo de correo no puede estar vacio',
    ...
    listarProveedor() {
     ...
     if(me.contador==0){
      ...
      const url=  '/proveedor/deshabilitado?page='+me.pagination.current_page+ '&buscar='+ me.search;
