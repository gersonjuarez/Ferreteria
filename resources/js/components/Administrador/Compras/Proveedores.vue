   ...
   <div
      ...
      ></v-progress-linear>
        ...
        <v-dialog v-model="dialogDesactivar" max-width="500px">
          <v-card>
            <v-card-title class="text-h5">¿Quieres deshabilitar este proveedor?</v-card-title>
            <v-card-actions>
              <v-spacer></v-spacer>
...
>
      ...
      <v-tooltip
        ...
        >
          <template v-slot:activator="{ on, attrs }">
            <v-btn
              @click="desactivarProveedor(item.id,item.estado)"
              icon
              v-bind="attrs"
              v-on="on"
              class="outlin"
...
export default {
  ...
  data(){
      ...
      search: '',
       ...
       NombreRules: [
        ...
        NumeroRules: [
        v => !!v || 'Numero de documento requerido.',
      ],
       DireccionRules: [
        v => !!v || 'Dirección requerido.',
      ],
       TelefonoRules: [
 ...
 v => !!v || 'El campo de correo no puede estar vacio',
      ...
      Telefono_Con_Rules:[
    v => !!v || 'Telefono de contacto requerido.',
      ...
      desserts: [],
      editedIndex: -1,
        id_proveedor_temp:null,
        proveedor_id:null,
        iddocumento:{id:1,nombre:'DNI'},
        idproveedor:null,
        ...
        aux:null
          ...
          computed: {
      formTitle () {
        return this.editedIndex === -1 ? 'Registrar Proveedor' : 'Editar Proveedor'
      },
     ...
     envioidpresentacion(id){
      ...
      closeDelete () {
        ...
        me.desserts.map(function(item){
          ...
          if(item.id==me.id_proveedor_temp){
            item.estado=1;
          }

        })
        me.id_proveedor_temp=null;
    ...
    listarProveedor() {
     ...
     if(me.contador==0){
      ...
      const url=  '/proveedor?page='+me.pagination.current_page+ '&buscar='+ me.search;
      ...
      axios
        ...
        me.desserts=[];
         ...
         console.log('informacion de proveedores: '+JSON.stringify(respuesta))
   ...
   console.log('valor: '+this.pagination.current_page)
     ...
     axios
        .put("/proveedor/actualizar", {
         ...
         nombre:me.nombre_proveedor,
       tipo_documento:me.iddocumento,
       num_documento:me.numero,
      ...
      axios.post("proveedor/registrar", {
            tipo_documento: me.iddocumento.nombre,
            nombre:me.nombre_proveedor,
            num_documento:me.numero,
            direccion:me.direccion,
            telefono:me.telefono,
        ...
        .catch(function (error) {
         ...
         /* DESACTIVAR Proveedor*/
           desactivarProveedor(id,estado) {
             console.log('estado: '+estado)
             this.id_proveedor_temp=null;
            if(estado==0){
           this.dialogDesactivar=true;
           this.id_proveedor_temp=id;
            }
        ...
        me.id_proveedor_temp=null,
        me.proveedor_id=null,
        me.iddocumento={id:1,nombre:'DNI'},
        me.idproveedor=null,
